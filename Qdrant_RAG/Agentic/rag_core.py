...
class RAGChatbot:
    """
    Handles the core RAG logic. All streaming methods yield dictionaries
    to maintain a consistent data contract with the API layer.
    """
    ...
    async def stream_rag_response(self, question: str) -> AsyncGenerator[Dict, None]:
        ...
        This function strictly yields dictionaries to prevent type errors.
        """
        try:
